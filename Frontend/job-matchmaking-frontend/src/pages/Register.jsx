      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" 
        ...
        <div className="max-w-lg w-full bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-8 px-8 text-center">
            ...
            <p className="mt-2">Create your account and start your fitness journey</p>
          </div>
          ...
          <div className="px-8 py-10">
            {step === 1 && (
              <div className="space-y-6">
                <div className="text-center">
                  <div className="text-xl font-semibold text-gray-800 mb-6">Choose your account type</div>
            ...
            {step === 2 && (
              <form className="space-y-5" onSubmit={handleSubmit}>
                <div className="text-center">
                  <div className="text-xl font-semibold text-gray-800 mb-6">Personal Information</div>
                  <div className="w-full bg-gray-200 h-2 rounded-full mb-8">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  I agree to the <a href="#" className="text-blue-600 hover:underline">Terms</a> & <a href="#" className="text-blue-600 hover:underline">Privacy</a>
                </div>
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  <button
                    type="submit"
                    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-xl transition flex items-center"
                  >
                    Register
